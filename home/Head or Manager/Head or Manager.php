...
<html>
    ...
    <body>
        ...
        <div id="tab-asset">
            <div id="tabbed">
                <ul>
                    <li><a href="#" id= "hm-trans" role = "button"> <br>Transfer  </a></li>
                    <li><a href="#" id= "hm-req-list" role = "button"> Request <br>List</a></li>
                    <li><a href="#" id= "hm-req-item" role = "button"> Request <br> Item</a></li>
                    <li class="active"> <a href="#" id= "hm-view-asset" role = "button"> View List <br> Assets </a></li>
                </ul>
            </div>
        </div>

        <div id="HM-View-Assets">
        ...
        <div id="HM-Req-Items" style="display:none;">
            <p id="title"> LIST OF ASSETS</p>
            <table border='1' id="details">
                <tr>
                    <th>FFE Code</th>
        ...
        <div id="HM-Req-list" style="display:none;">
            <p id="title"> LIST OF ASSETS</p>
            <table border='1' id="details">
                <tr>
                    <th>FFE Code</th>
        ...
        <div id="HM-transfer" style="display:none;">
            <p id="title"> LIST OF ASSETS</p>
            <table border='1' id="details">
                <tr>
                    <th>FFE Code</th>
