    ...
    <body>
        ...
        <nav>
			<ul class="ul-sidenav">
                ...
                <li class="li-sidenav"><a href="PH-acct.php"><img class="icons" src="../../res/MA.png"/>My Account</a></li>
        ...
        <div id="tab-asset">
            <div id="tabbed">
                <ul>
                    <li><a href="#" id= "phead-trans" role = "button"> <br>Transfer  </a></li>
                    <li><a href="#" id= "phead-req-list" role = "button"> Request <br>List</a></li>
                    <li><a href="#" id= "phead-req-item" role = "button"> Request <br> Item</a></li>
                    <li class="active"> <a href="#" id= "phead-view-asset" role = "button"> View List <br> Assets </a></li>
                </ul>
            </div>
        </div>

        <div id="PH-View-Assets">
        ...
        <div id="PH-Req-Items" style="display:none;">
            <p id="title"> LIST OF ASSETS</p>
            <table border='1' id="details">
                <tr>
                    <th>FFE Code</th>
        ...
        <div id="PH-Req-list" style="display:none;">
            <p id="title"> LIST OF ASSETS</p>
            <table border='1' id="details">
                <tr>
                    <th>FFE Code</th>
        ...
        <div id="PH-transfer" style="display:none;">
            <p id="title"> LIST OF ASSETS</p>
            <table border='1' id="details">
                <tr>
                    <th>FFE Code</th>
